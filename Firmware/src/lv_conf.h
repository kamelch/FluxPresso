...
/*Swap the 2 bytes of RGB565 color. Keep at 0 — the HAL flush callback uses
  draw16bitRGBBitmap which byte-swaps each pixel for the big-endian QSPI bus.
  Setting this to 1 would double-swap and corrupt colors.*/
